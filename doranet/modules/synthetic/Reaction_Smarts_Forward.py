...
class OperatorSmarts:    
    ...
    Retro_Not_Aromatic: typing.Optional[bool] = False # only useful in retro list
...
#        # may need enthalpy correction
    ...
    OperatorSmarts("Friedel–Crafts Acylation with Acid Anhydrides", 
                   ...
                   (1, 1),(1, 1)),     # Intramolecular version causes error: non-ring atom 6 marked aromatic   
...
#           # produces same result as Wurtz reaction, may be redundant? Not sure if intramolecular possible for Suzuki coupling
    ...
    OperatorSmarts("Baeyer-Villiger Oxidation (Ketones)", 
                   ...
                   (1, 0.5),(1, )),           # may use kekulize_flag = True but needs confirmation
    ...
    OperatorSmarts("Transesterification", 
                   ...
                   (1, 1),(1, 1)),
    OperatorSmarts("Transesterification, Intramolecular",   # ring issue: doesn't work for OCCCCOC(=O)C
                   "([C+0:1](=[O+0:2])!@[O+0:3][*+0:4].[*+0:6][O+0H;!$(*-C=O):5])>>[*:1](=[*:2])[*:5][*:6].[*:4][*:3]",
                   (1, ),(1, 1),
                   ring_issue = True,
                   kekulize_flag = True),      
...
#                   (1, 0.5),(1, 1)),
    ...
    OperatorSmarts("Hydrolysis of Amides, Intramolecular", 
                   ...
                   (1, 1),(1, )),   
    # Hofmann Elimination
    OperatorSmarts("Hofmann Elimination R-NH2", 
                   "[C+0X4!H0:1][CX4+0:2][N+0H2:3].[C+0:4][F,Cl,Br,I;+0:5]>>[*:1]=[*:2].[*:3]([*:4])([*:4])[*:4].[*:5]",
                   (1, 3),(1, 1, 3)),  
    OperatorSmarts("Hofmann Elimination R-NHR", 
                   "[C+0X4!H0:1][CX4+0:2]-!@[N+0H:3].[C+0:4][F,Cl,Br,I;+0:5]>>[*:1]=[*:2].[*:3]([*:4])[*:4].[*:5]",
                   (1, 2),(1, 1, 2)),  
    OperatorSmarts("Hofmann Elimination R-NHR Ringopening", 
                   "[C+0X4!H0:1][CX4+0:2]-@[N+0H:3].[C+0:4][F,Cl,Br,I;+0:5]>>([*:1]=[*:2].[*:3]([*:4])[*:4]).[*:5]",
                   (1, 2),(1, 2)),  
    ...
    OperatorSmarts("Sulfides Hydrogenolysis", 
                   ...
                   (1, 2),(1, 1, 1)),
    OperatorSmarts("Sulfides Hydrogenolysis, Intramolecular", 
                   "[C+0:1]-@[SX2+0:2][C+0:3].[H][H]>>([*:1].[*:3]).[*:2]",
                   (1, 2),(1, 1),
                   kekulize_flag = True),                                      # works for aromatic ring       
    ...
    OperatorSmarts("Oxidation of Sulfides", 
    ...
    OperatorSmarts("Disproportionation of Aromatic Sulfinic Acids", 
